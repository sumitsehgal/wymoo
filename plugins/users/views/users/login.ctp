	...
	?>
		<table width="100%" border="0" cellspacing="8" cellpadding="0">
			...
			<tr>
				<td>&nbsp;</td>
				<td>
					<small  style="color:#FF0000;"> <?php echo $form->error($model.'.client_email');?> </small>
				</td>
			</tr>
			<?php 
			}
  ...
  <div class="content_box">
    ...
    <div class="login_outer">
       ...
       <div class="login_inner">
		...
		echo $this->Form->create($model, array('action' => 'login','class' => 'form-horizontal'));
        ...
        <?php echo $form->password('passwd',array("class"=>'form-control')); ?>
        <img src="<?php echo WEBSITE_URL;?>images/passwordicon.png" class="pass_icon" alt="pass"/>
		<?php echo $form->submit('goicon.png',array("class"=>"go_button")); ?>
		<?php
		echo $this->Form->end();
		...
		?>
          ...
          <strong>
       <?php echo $this->Html->link('Forgot your password?',array('plugin'=>'users','controller'=>'users','action'=> 'forgot_password'),array('id'=>'forgot_password','class'=>'newlink'));?>
        <span>Are you starting a new case? <?php echo $this->Html->link('Click here.',array('plugin'=>'cases','controller'=>'cases','action'=> 'casebegin'),array('class'=>'newlink'));?></span>
