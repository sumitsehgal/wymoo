<?php
echo $javascript->link(array('jquery-ui.min.js','jquery.stylish-select.js','jquery.mousewheel.js','jquery.jscrollpane.min.js'),false); 
...
echo $javascript->codeBlock('$(window).load(function() {
	//mCustomScrollbars();
});
function mCustomScrollbars(){
	...
	*/
	$("#mcs1_container").mCustomScrollbar("vertical",200,"easeOutCirc",1,"fixed","yes","no",0); 
	$("#mcs2_container").mCustomScrollbar("vertical",200,"easeOutCirc",1,"fixed","yes","no",0); 
	$("#mcs3_container").mCustomScrollbar("vertical",0,"easeOutCirc",1,"fixed","yes","no",0); 
	$("#mcs5_container").mCustomScrollbar("vertical",0,"easeOutCirc",1,"fixed","yes","no",0); 
	$("#mcs6_container").mCustomScrollbar("vertical",200,"easeOutCirc",1,"fixed","yes","no",0); 
	$("#mcs7_container").mCustomScrollbar("vertical",0,"easeOutCirc",1,"fixed","yes","no",0); 
...
function LoadNewContent(id,file){
 ...
 $(document).ready(function () {
  ...
  $("#fancybox-outer",window.parent.document).mousewheel(function(event, delta) { 
 		 event.stopPropagation();
  		$("#fancybox-wrap",window.parent.document).trigger("mousewheel.fb", delta);
	});

  			
		  $("#fancybox-content" , window.parent.document).css("height", $("body").height());
		  $("#fancybox-frame" , window.parent.document).css("height", $("body").height());
		  
		  $("#fancybox-content" , window.parent.document).css("width", "990px");
		  $("#fancybox-outer" , window.parent.document).css("width", "1000px");
		  $("#fancybox-wrap" , window.parent.document).css("width", "1010px");
		  ...
		  $("#edit_case").click(function(e){
		   ...
		   $("#status_case").click(function(e){
			  window.parent.location.href = $(this).attr("href");  
			   e.preventDefault();
		  
		  });
		  $("#notify_client").click(function(e){
			 
			  $( "div#notify_client_dialog").dialog("open");
			 
			  e.preventDefault();
		});
		$("div#notify_client_dialog" ).dialog({
				autoOpen: '. $autoOpen  .',
				width:450,
				modal:true
		...
		$("div#notify_client_dialog" ).find("#save_notify").click(function(e){
			$("#CaseTableNotification").val( $("div#notify_client_dialog" ).find("#CaseTableNotification1").val());
			$("#CaseTableNotificationType").val("Admin");
		...
		$("div#email_case_dialog" ).find("#send_email").click(function(e){
			...
			window.location.href = "' . $email_caseurl. '" + "/" + $("#email_address").val();
				e.preventDefault();
		});
			
			$("a.ttt").mouseover(function() {
			
				 $("div#preview_dialog_info").load($(this).attr("href") + "/1",function(){
				   dlginfo.dialog("open");
				  });	
 				
		}).mousemove(function(event) {
			  dlginfo.dialog("option", "position", {
				my: "left top",
				at: "right bottom",
				of: event,
				offset: "20 20"
	 	...
	 	var dlginfo = $("#preview_dialog_info").dialog({ autoOpen: false,  draggable: false,  resizable: false});
	 });
...
<script type="text/javascript" >
		...
		$("#export_case1").click(function(e){
			...
			$("#export_case_lnk").click(function(e){
				...
				<?php if($disabled==false){
					...
					<?php if($role=='Administrator'){ ?>
					$("#floatright_btns").append('<div class="floatleft pr10"><div class="btnlt"></div><div class="btnmid"><?php echo $this->Html->link( $this->Html->image('unlock.png',array('style'=>'vertical-align: text-bottom;')).'&nbsp;&nbsp;Unlock Case',array('plugin'=>'cases','controller'=>'cases','action'=> 'unlocked','admin'=>true,$id),array('escape'=>false,'id'=>'export_case1','style'=>'color:#FFFFFF'));?></div><div class="btnrt"></div></div>');
					$("#export_case1").click(function(e){
						$("div#unlock_case_dialog").dialog("open");
						e.preventDefault();
					});
 ...
 <?php 	
 		...
 		echo $this->Form->create($model, array('class'=>'form-inline','url'=>array('plugin'=>'cases','controller'=>'cases','action'=>'casenotes',$id)));
		echo $this->Form->hidden($model.'.notification_type',array('value'=>'Investigator'));
		echo $form->textarea($model.'.notification',array('style'=>'display:none'));
?>
<script>
 ...
 <div class="floatleft pd20">
   <div class="pl20"><?php echo $form->textarea($model.'.notification1',array('class'=>'wid345 floatleft', 'rows'=>16));?><br /><small  style="color:#FF0000;"><?php echo $form->error($model.'.notification');?> </small></div>
 ...
 <div class="divfull pt15">
  ...
  <tr>
	...
	<div class="pt15">
    	<div class="bxheadlt"></div>
        <div class="bxheadmid"><?php echo $result['Quote']['quote_title'];?></div>
        <div class="bxheadrt"></div>
        <div class="clr"></div>
    </div>
	<div class="gridbxover1">
	  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblcaselist">
	    ...
	    <tr class="even">
	      ...
	      <td><?php   echo  $server_info['HTTP_USER_AGENT'];?> </td>
	      </tr>
	    <tr class="odd">
	      <td>Http Host:</td>
	      <td><?php   echo  $server_info['HTTP_HOST'];?></td>
	      </tr>
	    <tr class="even">
	      <td>Location:</td>
	      <td><?php   echo  $server_info['LOCATION'];?></td>
	      </tr>
           <tr class="odd">
	      <td>Description:</td>
    ...
    <div class="gridbxover1">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblcaselist">
		...
		<div class="scroll-pane" style="height:72px;width:305px;">
		  ...
		  <?php echo $this->Upload->view($model, $result[$model]['id'].'_photo');		?>
        ...
        <tr class="even">
         ...
         <div class="scroll-pane" style="height:73px;width:305px;">
		  ...
		  <?php echo $this->Upload->view($model, $result[$model]['id'].'_document');		?>
    ...
    <div class="scroll-pane" style="height:130px;width:490px;" >
      ...
      <table width="100%" style="width:490px;" border="0" cellspacing="0" cellpadding="0" class="tblcaselist">
        ...
        <?php 
          ...
          <td><div style="width: 288px; word-wrap: break-word;"><?php echo nl2br($Communication['comments'])  ;?></div> </td>
        </tr>
        <?php } ?>
    ...
    <div class="gridbxover1">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblcaselist">
        ...
        <tr class="odd">
          <td>Subject's Email:<br /></td>
          <td><?php echo $result[$model]['subject_email'];?></td>
        </tr>
        <tr class="even">
          <td>Subject's DOB:</td>
          <td><?php 
		echo  $result[$model]['subject_dob'] = ($result[$model]['subject_dob']==0) ? '' : date('d-M-Y',$result[$model]['subject_dob']);	
		   ?></td>
        </tr>
        <tr class="odd">
        ...
        <tr class="odd">
		 ...
		 <?php echo $result[$model]['subject_background'];?>
   ...
   <div class="scroll-pane" style="height:150px;">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tblcaselist">
        ...
        <?php 
				...
				<tr class="<?php echo $class;?>" <?php echo $style;?>>
          <td width="150"><?php echo $Communication['notification_type'] . '('. date('d-m-Y',$Communication['created']) ;?>):</td>
          <td ><div style="word-wrap:break-word;margin-right: 15px; width:290px"><?php echo nl2br($Communication['comments'])  ;?></div> </td>
        </tr>
        <?php } ?>
    ...
    <div class="divfull pt15">
        ...
        <?php if($disabled==false){ ?><div class="floatleft pr10" id="notify_client_btn">
        	<div class="btnlt"></div>
            <div class="btnmid">
            <?php 
			 echo $this->Html->link( 'Notify Client',array('plugin'=>'cases','controller'=>'cases','action'=> 'notify_client','admin'=>true,$id),array('id'=>'notify_client'));
			?>
           </div>
            <div class="btnrt"></div>
        </div> <?php }?>
        <div class="floatleft pr10">
            ...
            <div class="btnmid">
             <?php 
			 echo $this->Html->link( 'Email Case',array('plugin'=>'cases','controller'=>'cases','action'=> 'caseemail','admin'=>true,$id),array('id'=>'email_case'));
			?>
            </div>
            <div class="btnrt"></div>
            ...
            <div class="btnmid">  <?php 
			 echo $this->Html->link( 'Edit Case',array('plugin'=>'cases','controller'=>'cases','action'=> 'caseinfo','admin'=>true,$id),array('id'=>'edit_case'));
			?></div>
            <div class="btnrt"></div>
        </div><div class="floatleft pr10">
        	<div class="btnlt"></div>
            <div class="btnmid">
             <?php 
			 echo $this->Html->link( 'Case Status',array('plugin'=>'cases','controller'=>'cases','action'=> 'casetracker','admin'=>true,$id),array('id'=>'status_case'));
			?>
            </div>
            <div class="btnrt"></div>
        </div>
        ...
        <div class="floatleft pr10">
            ...
            <?php 				
			echo $this->Html->link( 'Export Case',array('plugin'=>'cases','controller'=>'cases','action'=> 'caseexport','admin'=>true,$id),array('id'=>'export_case','style'=>'color:#FFFFFF'));
?>
            
           </div>
            <div class="btnrt"></div>
        </div>
		<?php if($disabled && $role=='Administrator'){ ?>
        <div class="floatleft pr10">
        	<div class="btnlt"></div>
            <div class="btnmid">
			<?php echo $this->Html->link( $this->Html->image('unlock.png',array('style'=>'vertical-align: text-bottom;')).'&nbsp;&nbsp;Unlock Case',array('plugin'=>'cases','controller'=>'cases','action'=> 'unlocked','admin'=>true,$id),array('escape'=>false,'id'=>'export_case1','style'=>'color:#FFFFFF'));?>
  ...
  <tr>
	...
	<div class="gridbxover1">
      ...
      <div class="pl20"><?php echo $form->textarea($model.'.notes',array('class'=>'wid345 floatleft', 'rows'=>6,'disabled'=>$disabled));?><br /><small  style="color:#FF0000;"><?php echo $form->error($model.'.notes');?> </small></div>
      <div class="clr"></div>
 ...
 <div style="color: #535353;
    ...
    font-size: 12px;">
   <div id="no_case" style="text-align:justify">
   <br />
   ...
   <div id="unlock_case_dialog" title="Unlock Case" >
   <br/>
    Are you sure you want to unlock the case?
	<div class="floatright pt15" id="floatrightbtn" style="padding-top:20px;">
	<div class="btnlt"></div>
            <div class="btnmid"><?php
				echo $this->Html->link( 'Yes',array('plugin'=>'cases','controller'=>'cases','action'=> 'unlocked','admin'=>true,$id),array('id'=>'export_case_lnk','style'=>'color:#FFFFFF'));
				?></div>
            <div class="btnrt" style="padding-right:2px;"></div>
			
			<div class="btnlt"></div>
            <div class="btnmid"><?php
				echo $this->Html->link( 'No',array(),array('id'=>'close_dialog','style'=>'color:#FFFFFF'));
				?></div>
            <div class="btnrt"></div>
   </div>
   </div>
   ...
   <?php if($disabled) { echo 'The case has been locked, you cannnot change anything.'; if($role=='Administrator'){ echo 'To unlock this case click on "<b>Unlock Case</b>" button.'; } } else {echo 'This case will be locked and notes page will no longer be editable.';}?><br><br>
      ...
      <div class="floatright pt15" id="floatrightbtn">
        	<?php 
			 if($disabled) {
			 	//echo $this->Html->link( $this->Html->image('unlock.png',array('style'=>'vertical-align: text-bottom;')).'&nbsp;&nbsp;Unlock Case',array('plugin'=>'cases','controller'=>'cases','action'=> 'unlocked','admin'=>true,$id),array('escape'=>false,'id'=>'export_case','style'=>'color:#FFFFFF'));
			 } else { ?> <div class="btnlt"></div>
            <div class="btnmid"><?php
				echo $this->Html->link( 'Export Case',array('plugin'=>'cases','controller'=>'cases','action'=> 'caseexport','admin'=>true,$id),array('id'=>'export_case_lnk','style'=>'color:#FFFFFF'));
				?></div>
            <div class="btnrt"></div><?php
