...
<script type="text/javascript">
  $(function() {
      ...
      $("#CaseTableSubjectBackground").keyup(function() {
          $("#CaseTableSubjectBackground").val($("#CaseTableSubjectBackground").val().substring(0, 1000)).focus();
          var psconsole = $("#CaseTableSubjectBackground");
...
<div id="myTabContent" class="tab-content">
  ...
  <div id="edit" class="tab-pane fade active in">
      <div class="content_box">
          <form action="/client/caseinfo/7934" class="form-inline" id="CaseTableCaseinfoForm" method="post" accept-charset="utf-8">
...
>>>>>>> db94f96f7a7e735015ce221b010ab3a0be7297e2
              </div>
              <input type="hidden" name="data[CaseTable][id]" value="7934" id="CaseTableId">
                          ...
                          <div class="form_box photo_add">
                              <table width="100%" border="0" cellspacing="8" cellpadding="0">
                                  <tbody>
                                      <tr>
                                          <td>
                                              <div id="AjaxMultiUpload7934_photo">
                                              ...
                                              <select id="CaseTable7934_photo" data-placeholder="Click on Add to attach files" style="width: 450px; display: none;" class="chzn-select chzn-done" multiple="multiple" name="data[CaseTable][7934_photo][]"></select>
                                              <div id="CaseTable7934_photo_chzn" class="chzn-container chzn-container-multi" style="width: 450px;">
                                                  <ul class="chzn-choices">
                                                      <li class="search-field">
                                                          <input type="text" value="Click on Add to attach files" class="default" autocomplete="off" style="width: 178px;">
                                                      </li>
                                                  </ul>
                                                  <div class="chzn-drop" style="left: -9000px; width: 448.011px; top: 32px;">
                                      ...
                                      <tr>
                                          <td style="padding-top: 10px;">
                                              ...
                                              <div id="AjaxMultiUpload7934_document">
                                                  <div class="qq-uploader">
                                                      <div class="qq-upload-drop-area well" style="display: none;"><span>Drop files here to attach</span></div>
                                              ...
                                              <script>
                                                  ...
                                                  $(function() {
                                                      ...
                                                      $('#' + 'CaseTable' + '7934_document').chosen({
                                                          disabled: true
                                                      }).change(function() {
                                                          if ('/client/ajax-delete' != '') {
                                                              $('#' + 'CaseTable' + '7934_document' + ' option:not(:selected)').each(function() {
                                              ...
                                              <select id="CaseTable7934_document" data-placeholder="Click on Add to attach files" style="width: 450px; display: none;" class="chzn-select chzn-done" multiple="multiple" name="data[CaseTable][7934_document][]"></select>
                                              <div id="CaseTable7934_document_chzn" class="chzn-container chzn-container-multi" style="width: 450px;">
                                                  <ul class="chzn-choices">
                                                      <li class="search-field">
                                                          <input type="text" value="Click on Add to attach files" class="default" autocomplete="off" style="width: 178px;">
                                                      </li>
