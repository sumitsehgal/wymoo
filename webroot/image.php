...
$_GET['image']	=	  $_GET['image'].'';

$pos_height		=	strpos($_GET['height'],'px');
$_GET['height']	=	substr($_GET['height'],0,$pos_height);


$pos_width		=	strpos($_GET['width'],'px');
$_GET['width']	=	substr($_GET['width'],0,$pos_width);
...
define('DOCUMENT_ROOT',			'/var/www/html/wymooGit/wymoo/webroot/Php_data/uploads');
