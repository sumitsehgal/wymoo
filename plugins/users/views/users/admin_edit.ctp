<?php 
  ...
  echo $javascript->link(array('jquery.stylish-select.js','jquery.easing.1.3.js','jquery.mousewheel.min.js'),false); 
echo $javascript->codeBlock('$(document).ready(function () {$(".select").sSelect({ ddMaxHeight: "300px" });$("#update").click(function(e){			$("#UserAdminEditForm").submit();e.preventDefault();});$("#view_users").click(function(e){window.location.href="'.$add_user.'";e.preventDefault();});});',array('allowCache'=>true,'safe'=>true,'inline'=>false));
